    ...
    return (
        <div className="flex sm:mt-20 justify-center  items-center ">
            ...
            <div className="sm:grid sm:grid-cols-2 sm:gap-20 text-white sm:h-[800px] h-[1400px]">
                ...
                <div className="sm:col-span-1 hover:bg-gradient-to-r ease-in-out duration-1000 transition-all   bg-gradient-to-r from-black via-gray-900  w-72 rounded-3xl h-80 hover:rotate-6 hover:border-gray-700 hover:border border-transparent dark:bg-white dark:dark:bg-none dark:hover:border-orange-400 "> 
                <a href="https://github.com/JatinMehta007" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="sm:col-span-1  bg-gradient-to-r from-black via-gray-900 rounded-3xl h-80 sm:mt-20 mt-10 ease-in-out duration-1000 transition-all hover:border-gray-700 hover:border border-transparent dark:bg-white dark:bg-none dark:hover:border-orange-400">    
                ...
                <div className=" rounded-3xl col-span-1 w-72 h-80 sm:mt-20 mt-96 bg-gradient-to-r from-black via-gray-900 ease-in-out duration-1000 transition-all hover:-rotate-6 hover:border-gray-700 hover:border border-transparent dark:bg-white dark:bg-none dark:hover:border-orange-400">
